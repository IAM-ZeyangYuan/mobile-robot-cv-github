...
$$
\begin{pmatrix} 1 & 0 & -L \\ 1 & 0 & L \\ 0 & 1 & 0 \end{pmatrix}
{}_I^0 R \; {}^I\dot{P}
=
\begin{pmatrix} r & 0 \\ 0 & r \\ 0 & 0 \end{pmatrix}
...
$$
{}^I\dot{P} = \begin{pmatrix} \omega R\cos\theta \\ \omega R\sin\theta \\ \omega \end{pmatrix},
\qquad
\begin{pmatrix} \dot{\psi}_1 \\ \dot{\psi}_2 \end{pmatrix}
= \begin{pmatrix} \omega\frac{R-L}{r} \\ \omega\frac{R+L}{r} \end{pmatrix}
$$
